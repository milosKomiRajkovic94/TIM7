...
/**
 * Servlet implementation class VratiUtiskeServlet
 */
@WebServlet("/VratiUtiskeServlet")
public class VratiUtiskeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
    @EJB
    private RegistracijaRemote rrm;
    
    public ArrayList<Utiscioknjizi> listaUtisaka;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public VratiUtiskeServlet() {
        super();
